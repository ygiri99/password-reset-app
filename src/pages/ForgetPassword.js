...
export default function ForgetPassword() {
    ...
    const handleSubmit = async () => {
        try {
            let response = await axios.post(`${process.env.REACT_APP_BASE_URL}/forgot-password`, { email: value });
            if (response) {
    ...
    return (
        <div className='p-2 text-info-emphasis text-center d-flex flex-column gap-2 justify-content-center align-items-center bg-info-subtle border border-info-subtle h-100'>
